...
static const char* RUBIK_SOLVE_RATE_KEYS[] = {
    "solve_rate_depth_8", "solve_rate_depth_9", "solve_rate_depth_10",
    "solve_rate_depth_11", "solve_rate_depth_12", "solve_rate_depth_13",
    "solve_rate_depth_14", "solve_rate_depth_15", "solve_rate_depth_16",
    "solve_rate_depth_17", "solve_rate_depth_18", "solve_rate_depth_19",
    "solve_rate_depth_20",
};

static const char* RUBIK_DISTANCE_KEYS[] = {
    "distance_depth_8", "distance_depth_9", "distance_depth_10",
    "distance_depth_11", "distance_depth_12", "distance_depth_13",
    "distance_depth_14", "distance_depth_15", "distance_depth_16",
    "distance_depth_17", "distance_depth_18", "distance_depth_19",
    "distance_depth_20",
};

static const char* RUBIK_RETURN_KEYS[] = {
    "episode_return_depth_8", "episode_return_depth_9", "episode_return_depth_10",
    "episode_return_depth_11", "episode_return_depth_12", "episode_return_depth_13",
    "episode_return_depth_14", "episode_return_depth_15", "episode_return_depth_16",
    "episode_return_depth_17", "episode_return_depth_18", "episode_return_depth_19",
    "episode_return_depth_20",
};

static const char* RUBIK_FRAC_KEYS[] = {
    "frac_depth_8", "frac_depth_9", "frac_depth_10",
    "frac_depth_11", "frac_depth_12", "frac_depth_13",
    "frac_depth_14", "frac_depth_15", "frac_depth_16",
    "frac_depth_17", "frac_depth_18", "frac_depth_19",
    "frac_depth_20",
};

static inline void dict_set_depth_log(Log* log, Dict* out, int depth) {
    int idx = depth - 8;
    dict_set(out, RUBIK_SOLVE_RATE_KEYS[idx],
        safe_ratio(log->depth_solved[depth], log->depth_n[depth]));
    dict_set(out, RUBIK_DISTANCE_KEYS[idx],
        safe_ratio(log->depth_distance[depth], log->depth_n[depth]));
    dict_set(out, RUBIK_RETURN_KEYS[idx],
        safe_ratio(log->depth_return[depth], log->depth_n[depth]));
    dict_set(out, RUBIK_FRAC_KEYS[idx], log->depth_n[depth]);
}
...
void my_init(Env* env, Dict* kwargs) {
    ...
    env->curriculum_success_threshold = (float)dict_get(kwargs, "curriculum_success_threshold")->value;
